...
<div class="page-content-wrap" >
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="form-horizontal" method="GET" action="/reports/student-enrollment" id="form-filter">
...
<script>
    function print() {
        ...
        form.attr({
            "action": "{{ url('reports/print/student-enrollment') }}",
            "target": "_blank"
        });
        form.submit();
        form.attr("action", "{{ url('reports/student-enrollment') }}");
