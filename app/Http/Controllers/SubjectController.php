...
class SubjectController extends Controller
{
	...
	public function update(Request $request, Subject $subject) {
		$grade;
		if ($request->input('grade-level') == 'Grade 7') $grade = 'Grade 7';
		else if ($request->input('grade-level') == 'Grade 8') $grade = 'Grade 8';
		else if ($request->input('grade-level') == 'Grade 9') $grade = 'Grade 9';
		else $grade = 'Grade 10';
