...
<div class="page-content-wrap" >
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="form-horizontal" method="GET" action="/reports/student-enrollment">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <select class="form-control select" name="grade_level">
                                    <option value="">All</option>
                                    <option value="Grade 7"@if(request('grade_level') == 'Grade 7') selected @endif>Grade 7</option>
                                    <option value="Grade 8"@if(request('grade_level') == 'Grade 8') selected @endif>Grade 8</option>
                                    <option value="Grade 9"@if(request('grade_level') == 'Grade 9') selected @endif>Grade 9</option>
                                    <option value="Grade 10"@if(request('grade_level') == 'Grade 10') selected @endif>Grade 10</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <select class="form-control select" name="status">
                                    <option value="">All</option>
                                    <option value="Retained"@if(request('status') == 'Retained') selected @endif>Retained</option>
                                    <option value="Unenrolled"@if(request('status') == 'Unenrolled') selected @endif>Unenrolled</option>
                                    <option value="Enrolled"@if(request('status') == 'Enrolled') selected @endif>Enrolled</option>
                                </select>
                            </div>
                        </div>
    ...
    <div class="row" >
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Students Report</h3>
                    <ul class="panel-controls">
                        <li><button type="button" class="btn btn-primary btn-rounded" onclick="printDiv('section-to-print')" id="print-button"><span class="fa fa-print"></span> Print</button></li>
                    </ul>
                </div>
